            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                            ...
                            @foreach($brands as $brand)
                                <li class="mb-4" wire:key="{{$brand->id}}">
                                    <label for="{{$brand->slug}}" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" wire:model.live="selected_brands" id="{{$brand->id}}"
                                               value="{{$brand->id}}" class="w-4
                                         h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div>
                            <div
                                class="font-semibold">{{\Illuminate\Support\Number::currency($price_range,'RUB')}} </div>
                            ...
                            <div class="flex justify-between ">
                                ...
                                ">{{\Illuminate\Support\Number::currency(1000,'RUB')}}</span>
                                <span class="inline-block text-lg font-bold text-blue-400
                                ">{{\Illuminate\Support\Number::currency(500000,'RUB')}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{$product->id}}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="p-3 ">
                                        ...
                                        <p class="text-lg ">
                                            <span class="text-green-600 dark:text-green-600">{{\Illuminate\Support\Number::currency
                                            ($product->price,'RUB')}}</span>
                                        </p>
                                    </div>
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        ...
                                        <a wire:click.prevent="addToCart({{$product->id}})" href="#"
                                           class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
                                            ...
                                            <span wire:loading  wire:target='addToCart({{$product->id}})'>Adding..
                                                .</span>
                                        </a>
