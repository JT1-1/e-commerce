            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<span>
                        ...
                        <span>
						{{\Illuminate\Support\Number::currency($grand_total, 'RUB')}}
					</span>
                    </div>
                    <div class="flex justify-between mb-2 font-bold">
					<span>
                        ...
                        <span>
						{{\Illuminate\Support\Number::currency(0, 'RUB')}}
					</span>
                    </div>
                    <div class="flex justify-between mb-2 font-bold">
					<span>
                            ...
                            <li class="py-3 sm:py-4" wire:key="{{$ci['product_id']}}">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <img alt="{{$ci['name']}}" class="w-12 h-12 rounded-full" src="{{url('storage',
                                    $ci['image'])
                                    }}">
                                        </img>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        {{\Illuminate\Support\Number::currency($ci['total_amount'],'RUB')}}
                                    </div>
                                </div>
                            </li>
                        @endforeach
