                    ...
                    <div class="flex items-start justify-start flex-shrink-0">
                        <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
                            <div class="flex flex-col items-start justify-start space-y-2">
                                ...
                                dark:text-gray-400">{{$order->address->street_address}}</p>
                                <p class="text-sm leading-4 text-gray-600
                                dark:text-gray-400">{{$order->address->city}},{{$order->address->state}},
                                    {{$order->address->zip_code}}</p>
                                <p class="text-sm leading-4 cursor-pointer
                                dark:text-gray-400">Phone: {{$order->address->phone}}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        ...
                        <p class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                            {{\Illuminate\Support\Number::currency($order->grand_total, 'RUB')}}</p>
                    </div>
                    <div class="w-full px-4 mb-4 md:w-1/4">
                        <p class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                            Payment Method: </p>
                        ...
                        <div class="flex flex-col w-full space-y-6 ">
                            ...
                            <div
                                ...
                                <div class="flex justify-between w-full">
                                    ...
                                    dark:text-gray-400">{{\Illuminate\Support\Number::currency($order->grand_total, 'RUB')}}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Discount
                                    </p>
                                    <p class="text-base leading-4 text-gray-600 dark:text-gray-400">{{\Illuminate\Support\Number::currency(0,'RUB')}}</p>
                                </div>
                                <div class="flex items-center justify-between w-full">
                                    <p class="text-base leading-4 text-gray-800 dark:text-gray-400">Shipping</p>
                                    <p class="text-base leading-4 text-gray-600
                                    dark:text-gray-400">{{\Illuminate\Support\Number::currency(0, 'RUB')}}</p>
                                </div>
                            </div>
                            <div class="flex items-center justify-between w-full">
